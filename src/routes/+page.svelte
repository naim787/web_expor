...
<div class="dark:bg-gray-950 text-black dark:text-white overflow-hidden">
    <Nav />
    <div class="w-[100vw] h-auto p-4 " bind:this={scrollEl} data-scroll-container>
      ...
      <!-- section -->
       ...
       <!-- layer 2 -->
       <div class="w-full h-auto dark:bg-gray-950">
         <div class="w-full  md:w-[90vw] h-50 md:dark:bg-black md:inset-shadow-sm md:inset-shadow-white/20 flex items-center md:rounded-r-full absolute left-0 p-2">
          <h1 class="bungee-regular text-5xl">Pilih Desainmu</h1>
         </div>
         <div class="w-full h-auto flex flex-wrap  gap-2 justify-evenly md:w-[80%] pt-55 pb-4 dark:md:bg-gray-900 dark:md:rounded-b-4xl">
          <div class="w-120 h-70  bg-black inset-shadow-sm inset-shadow-white/50 rounded-md"></div>
          <div class="w-120 h-70  bg-black inset-shadow-sm inset-shadow-white/50 rounded-md"></div>
          <div class="w-120 h-70  bg-black inset-shadow-sm inset-shadow-white/50 rounded-md"></div>
          <div class="w-120 h-70  bg-black inset-shadow-sm inset-shadow-white/50 rounded-md"></div>
          <div class="w-120 h-70  bg-black inset-shadow-sm inset-shadow-white/50 rounded-md"></div>
          ...
          <div class="w-full flex justify-center p-2">
            <GradientButton shadow color="pink">Lihat Semua</GradientButton>
          </div>
         </div>
       </div>
