...
<div class="dark:bg-gray-950 dark:text-white w-[100vw] h-[100vh] p-2 z-10 backdrop-blur-2xl">
...
<div class="w-[20vw] h-[20vw] absolute top-0 left-0 bg-blue-800 rounded-full z-[-1px]"></div>