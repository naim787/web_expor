...
<div class="w-auto h-auto" bind:this={scrollEl} data-scroll-container>
  ...
  <div class="w-[100vw] h-[100vh] dark:bg-gray-950 text-black p-4 dark:text-white overflow-hidden border" >
  
    <!-- section -->
     <div class="w-[100vw] h-auto flex justify-center items-center">
       <div class="w-120">
