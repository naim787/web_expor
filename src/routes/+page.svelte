...
<Navbar>
  <NavBrand href="/">
    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">WEB<span class="font-bold">EXPOR </span></span>
  </NavBrand>
  <NavHamburger />
  <NavUl {activeUrl} >
    ...
    <NavLi href="/" class="text-black bg-white">Avatar</NavLi>
  </NavUl>
</Navbar>